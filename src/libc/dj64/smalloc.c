...
/*
 * NOTE: this file is a port of smalloc.c file from fdpp project.
 * In fdpp project it is distributed under the terms of GNU GPLv3+
 * with an authorship of Stas Sergeev (stsp).
 * As an author of the aforementioned smalloc.c, I donate the code
 * to dj64dev project, allowing to re-license it under the terms
 * of GNU LGPLv3+.
 *
 * --stsp
 */
