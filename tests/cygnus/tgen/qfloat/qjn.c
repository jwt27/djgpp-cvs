...
#if 0
/* #if DEBUG */
	qtoe( u, (unsigned short *) &du );
	fprintf(stderr, "pseries term: %.5e\n", du );
#endif
...
if( i > NBITS/2
    || DEBUG )
	fprintf(stderr, "qjn pseries: %d bits cancellation\n", i );
#endif
...
if(i > NBITS/2
    || DEBUG )
  {
    qtoe( n, (unsigned short *) &dconv );
    printf( "qhank(%.5e,", dconv );
    qtoe( x, (unsigned short *) &dconv );
    printf( "%.5e): ", dconv );
