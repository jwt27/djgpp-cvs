// ------------------------------------------------------
// genlog2v - generates test vectors for log2() & log2f()
// ------------------------------------------------------
#include <errno.h>
#include <float.h>
#include <math.h>
...
static	const	qfloat LOG2 = xlog(2);
// -------------------------------------------------------------------
...
GenDblVector(char *Name)
{
    ...
    // Generate first five lines of file

    // print external definition for log2()

    printf("#ifdef __DJGPP__\n"
	...
	{
	    Argument = K;
	    Expected = xtod(xlog(Argument)/LOG2);
...
GenFltVector(char *Name)
{
    ...
    // print external definition for log2f()
